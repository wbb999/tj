		...
		<tr>
			<td width="670" valign="top">
				<table border="0" align="center" cellpadding="0" cellspacing="0"
					...
					<tr>
						<td>
							<form action="nomalquestion_add" method="post"
								...
								<p>
									<label style="float: left">问题：<br /> <br /> <br /> <br />
										<br />
									</label>
									<textarea name="question.question" id="question.question"
										...
										onchange="check(this,ContentUseq,ContentRemq,254)"> </textarea>
								</p>
								<center>
									<font color="#7F7F7F"> [信息内容最多不得超过254个字符]</font> &nbsp; <font
										color="#7F7F7F"> 已用：<input type="text"
								...
								<p>
									<label style="float: left">回答：<br /> <br /> <br /> <br />
										<br />
									</label>
