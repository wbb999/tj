		...
		<tr>
			<td width="670" valign="top">
				<table border="0" align="center" cellpadding="0" cellspacing="0"
					id="register">
					<tr>
						<td class="title">更新用户信息</td>
					</tr>
					<tr height="30px;"></tr>
					<tr>
						<td>
							<form action="user_admindomodify" method="post"
								...
								<table width="90%" border="0" align="center" cellpadding="5"
									...
									<tr>
										...
										<td><c:if test="${adminuser.getType().getId()==1}">
											...
											disabled="disabled" <c:if test="${oneuser.getType().getId()==4}">checked="checked"</c:if>/>普通用户</td>
									</tr>
									<tr height="35px">
										<td>联系电话：</td>
										<td><input type="text" id="oneuser.phone"
											name="oneuser.phone" value="${oneuser.phone}" /></td>
										<td></td>
									</tr>
									<tr height="35px">
										<td>联系邮箱：</td>
