...
body,div,h1,ul,a,li,iframe,center,form ,h3,h5{
	margin: 0px;
	padding: 0px;
}
/*--events--*/
...
<body>
	<h4 style="float:left">详情查看 -->精彩作品详情查看</h4><input type="button" value="返回" onclick="history.go(-1)" style="float:right;margin-right:45px;margin-top:15px;border:none;border-bottom-color: #fff;color:blue"><br/>
	<div style="width: 100%; height: 804px">
	<form action="" method="post" ></form>
		<div id="divrent">
			<img src="${production.picture }">
			<h5 class="sumb">作品名：${production.name}</h5>
			<h5 class="sumb">作品时间：<fmt:formatDate value='${production.time }' pattern='yyyy-MM-dd HH:mm:ss' /></h5>
			<h5 class="sumb" style="margin-bottom: 20px;">作品地点：${production.address}</h5>
			<div style="float: left;width: 200px;margin:5px;padding:10px;color:color:#2F3338;border: 1px solid #ccc;border-radius: 1em;background-color: white;">作品详情：${production.detail}</div>
		</div>
		<div id="divrent">
			<h4>最新发布</h4>
