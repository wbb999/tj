		...
		<tr>
			<td width="670" valign="top">
				<table border="0" align="center" cellpadding="0" cellspacing="0"
					id="register">
					<tr>
						<td class="title">产品添加</td>
					</tr>
					<tr height="30px;"></tr>
					<tr>
						<td>
							<form action="service_product_add" method="post"
								...
								<p>
									<label for="name">产品名称：</label> <input class="inputstyle"
										...
										onblur="checksize(this,10)" onchange="checksize(this,10)" /><font
										color="#7F7F7F"> [10个字以内]</font>

								</p>
								<p>
									<label for="email">产品类别：</label> <input type="radio"
										name="service_product.type.id" id="service_product.type.id" value="1"
										checked="checked" />实体产品 <input type="radio"
										name="service_product.type.id" id="service_product.type.id" value="2" />服务产品
										<input type="radio"
										name="service_product.type.id" id="service_product.type.id" value="3" />租赁产品
